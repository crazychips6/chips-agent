...
Adapted from Hermes holographic plugin for chips-agent.
"""
...
class MemoryStore:
    ...
    def update_fact(self, fact_id: int, content: str | None = None,
                    trust_delta: float | None = None, tags: str | None = None,
    ...
    def list_facts(self, category: str | None = None,
                   min_trust: float = 0.0, limit: int = 50) -> list[dict]:
        with self._lock:
    ...
    def _rebuild_bank(self, category: str) -> None:
        with self._lock:
            ...
            self._conn.execute(
                ...
                "vector=excluded.vector, dim=excluded.dim, fact_count=excluded.fact_count, updated_at=CURRENT_TIMESTAMP",
